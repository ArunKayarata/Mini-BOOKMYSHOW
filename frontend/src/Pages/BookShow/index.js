...
const STRIPE_KEY = "pk_test_51OTHP8SA9Eq4G3o1ZGlknrTvjRy9m6awWoP6RLBDit2X62dhHeEK5m9m9tEuEiZyZbG0iTyynXiQnKBozOmJrKPe00NJlEoszR"
    ...
    show && (
      <div>
        ...
        <div className="flex justify-between card p-2 items-center">
          <div>
            <h1 className="text-sm">{show.theaterId.name}</h1>
            <h1 className="text-sm">{show.theaterId.address}</h1>
          </div>
